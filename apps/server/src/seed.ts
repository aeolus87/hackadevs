...
const SEED_CHALLENGES: {
  ...
  },
  {
    ...
    constraints: ['Do not use the built-in sort if your language provides merge — implement merge logic'],
  ...
  },
  {
    ...
    constraints: ['Leading and trailing hyphens must be stripped', 'Empty input becomes empty string'],
